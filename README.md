...
## [RE:ON](https://i9c203.p.safy.io/) :film_frames:
...
- 홀로 **연기 연습**, 다른 유저와 **연기 배틀**이 가능합니다.:film_frames:
...
|              연기 대결을 하기 전 백스테이지입니다!              |               연기 대결을 진행하는 배틀룸입니다!               |
...
| 혼자 연기 연습을 할 수 있는 페이지입니다. | 연기를 진행한 뒤 배틀과 동일하게 AI로 채점을 진행합니다. |
